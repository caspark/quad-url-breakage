...
var quad_url_ctx = null;

function quad_url_set_url(params, hash) {
...
miniquad_add_plugin({
  register_plugin: function (importObject) {
    ...
    importObject.env.quad_url_set_program_parameter = function (
      name_rs,
      value_rs
    ) {
      ...
      quad_url_set_url(params.toString(), null);
    };
    ...
    importObject.env.quad_url_set_hash = function (hash) {
      quad_url_set_url(null, get_js_object(hash));
    };
  },
  on_init: function (wasm_memory, _wasm_exports) {
    console.log("registering quad_url");
    quad_url_ctx = {};
  },
  name: "quad_url",
  version: "0.1.0",
